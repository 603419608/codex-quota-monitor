...
1. Download `codex-quota-monitor-win-x64-v0.1.5.zip` from the [latest Release](../../releases/latest).
...
1. 从 [最新 Release](../../releases/latest) 下载 `codex-quota-monitor-win-x64-v0.1.5.zip`。
